...
function getFileName(url) {
  ...
  return url.substring(url.lastIndexOf('/', url.length) + 1, url.length);
}
...
function parseQueryString(query) {
  ...
  // }
  // console.log(query);
  params.file = decodeURI(query).replace('file=', '');
  // console.log(params);
  return params;
}
...
function noContextMenuHandler(e) {
  console.log("dvd - noContextMenuHandler");
...
function getPDFFileNameFromURL(url) {
  ...
  console.log("DVD : suggestedFilename");
  ...
  ViewHistory.prototype = {
    _writeToStorage: function ViewHistory_writeToStorage() {
      return new Promise(function (resolve) {
        ...
        // DVD: 
        console.log("data dari View History")
        // console.log(dataHistory);
        // console.table(JSON.parse(databaseStr).files)
...
var PDFLinkService = (function () {
  ...
  PDFLinkService.prototype = {
    ...
    setHash: function PDFLinkService_setHash(hash) {
      if (hash.indexOf('=') >= 0) {
        var id = this.documentFingerprint;

        console.log("id hash " + id);



        console.log("DVD: hash");
        console.log(hash);
        console.log("-----------------------------");
...
var PDFViewerApplication = {
  ...
  initialize: function pdfViewInitialize() {
    ...
    SecondaryToolbar.initialize({
      ...
      dualPage: document.getElementById('secondaryDualPage'),
  ...
  open: function pdfViewOpen(file, args) {
    ...
    console.log("DVD: fungsi open parameters");
    ...
    console.log("file memiliki / membawa parameter");
  ...
  load: function pdfViewLoad(pdfDocument, scale) {
    ...
    pdfDocument.getMetadata().then(function (data) {
      ...
      console.log("DVD: info file");
      // ngambil dari databse
      const readHistory = JSON.parse(localStorage.getItem('database'));
      // ngambil dari global variable sebelum kena timpa

      const bacaan = dataHistory.files.filter(id => id.fingerprint.match(pdfDocument.fingerprint))


      console.table(bacaan)

      console.log("Histo--------------------");
      // console.table(dataHistory.files)



      // body.scrollTo(400)
      // window.scroll(400)
      PDFViewerApplication.page = bacaan[0].page;
      // console.log();
...
function webViewerInitialized() {
  ...
  var queryString = document.location.toString().replace(document.location.origin + document.location.pathname, '').substring(1);
